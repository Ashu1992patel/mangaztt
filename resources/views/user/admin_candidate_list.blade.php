...
@stop
@section('content')
    {!! Form::open(['url' => 'admin_s_user', 'class' => 'form-horizontal', 'id'=>'user_master']) !!}

    <div class="dash_head">
        <div class="col-sm-3 dash_txt">List of Registered Users
...
{{--                                @if($search_user->is_show_pic == '1')--}}
                            ...
                            <div class="cand_details">
                                <div class="cand_name"
                                     style="cursor: pointer;">{{$search_user->name}}{{' (MM-'.$search_user->id.')'}}
                                ...
                                <ul class="cand_info">
                                    ...
                                    <li data-toggle="tooltip" data-placement="bottom"
                                        title="Email">{{\Illuminate\Support\Str::limit( $search_user->email)}}</li>
                            ...
                            <div class="cand_btnbox">
                                ...
                                <div class="btn-group cand_btncontainner">
                                    ...
                                    <a onclick="view_user_contact('{{$search_user->id}}')"
                                       class="popup_submitbtn_view btn-xs btn-danger"
