                    ...
                    <div class="form_allcontainer">
                        ...
                        <fieldset style="display: none;">
                            ...
                            <div class="row form-group">
                                <div class="col-sm-6">
                                    <select name="drinking_habit" class="form-control requiredDD txt_wizard">
                                        <option selected="" value="0">Drinking Habits*</option>
                                ...
                                <div class="col-sm-6">
                                    <select name="smoking_habit" class="form-control requiredDD txt_wizard">
                                        <option selected="" value="0">Smoking Habits*</option>
                                        <option value="Yes">Yes</option>
                                        <option value="No">No</option>
                                    </select>
                                </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-6">
                                    <select id="p_physical1" class="form-control txt_wizard" name="p_physical">
                            ...
                            <div class="row form-group">
                                <div class="col-sm-6">
                                    <select name="f_type" class="form-control requiredDD txt_wizard">
                                        <option value="Not mentioned">Family Type</option>
                                ...
                                <div class="col-sm-6">
                                    <select name="f_status" class="form-control requiredDD txt_wizard">
                                        <option value="Not mentioned">Family Status</option>
                        ...
                        <fieldset style="display: none;">
                            ...
                            <div class="row form-group">
                                <div class="col-sm-6">
                                    <select name="p_drinking_habit" class="form-control requiredDD txt_wizard">
                                        <option selected="" value="0">Drinking Habits*</option>
                                        <option value="Yes">Yes</option>
                                        <option value="No">No</option>
                                    </select>
                                ...
                                <div class="col-sm-6">
                                    <select name="p_smoking_habit" class="form-control requiredDD txt_wizard">
                                        <option selected="" value="0">Smoking Habits*</option>
                                        <option value="Yes">Yes</option>
                                        <option value="No">No</option>
                                    </select>
