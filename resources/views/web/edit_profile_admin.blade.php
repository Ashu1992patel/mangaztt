                                ...
                                <div class="update_profile_row row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="textbox_containner">
                                            ...
                                            <label class="animate_placeholder" for="name">DOB</label>
                                        </div>
                                     ...
                                     <div class="col-sm-6">
                                        <div class="textbox_containner">
                                            ...
                                            <input type="text" editable="false" name="address" autocomplete="off"
                                                   class="animate_txt" id="address" placeholder="Contact Address"
                                                   value="{{$user->address}}">
                                            <label class="animate_placeholder" for="Subcast">Contact Address</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="update_profile_row row">
                                ...
                                <div class="row update_profile_row">
                                    <div class="col-sm-6">
                                        <select name="f_type" class="form-control txt_wizard drop_edit">
                                            <option {{$user->f_type == 'Joint' ? 'selected' :''}} value="Joint">JOINT
                                            </option>
                                            <option {{$user->f_type == 'Nuclear' ? 'selected' :''}} value="Nuclear">
                                                NUCLEAR
                                            </option>
                                            <option {{$user->f_type == 'Other' ? 'selected' :''}} value="Other">OTHER
                                            </option>
                                        </select>
                                    </div>
                                    <div class="col-sm-6">
                                        <select name="f_status" class="form-control requiredDD txt_wizard drop_edit">
                                            <option {{$user->f_status == 'Rich' ? 'selected':''}} value="Rich">RICH
                                            </option>
                                            <option {{$user->f_status == 'Upper middle class' ? 'selected':''}} value="Upper middle class">
                                                UPPER MIDDLE
                                            </option>
                                            <option {{$user->f_status == 'Middle class' ? 'selected':''}} value="Middle class">
                                                MIDDLE
                                            </option>
                                        </select>
                                ...
                                <div class="row update_profile_row">
                                    <div class="col-sm-6">
                                        <select name="f_values" class="form-control txt_wizard drop_edit">
                                            ...
                                            <option {{$user->f_values == 'Orthodox' ? 'selected' : ''}} value="Orthodox">
                                                ORTHODOX
                                            </option>
                                            <option {{$user->f_values == 'Traditional' ? 'selected' : ''}} value="Traditional">
                                                TRADITIONAL
                                            </option>
                                            <option {{$user->f_values == 'Moderate' ? 'selected' : ''}} value="Moderate">
                                                MODERATE
                                            </option>
                                            <option {{$user->f_values == 'Liberal' ? 'selected' : ''}} value="Liberal">
                                                LIBERAL
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="row update_profile_row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="textbox_containner">
                                            ...
                                            <input type="time" name="tob" autocomplete="off" editable="false"
                                                   class="animate_txt " id="tob"
                                                   placeholder="Time of Birth"
