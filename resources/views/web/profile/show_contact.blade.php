                    ...
                    @if($user->is_show_contact == '1' || $user->is_show_contact == '2')
                        ...
                        @elseif($user->is_show_contact == '1')
                            <label for=""
                                   class="control-label">{{isset($user->contact)?$user->contact:'Not Mentioned'}}</label>
                        @else
                            <label for="" class="control-label">This User has choosen to hide phone number</br> But You can Send Interest & Accept by Member After then You Can See Contact Number</label>
                        @endif
                    @else
                        <label for="" class="control-label">This User has choosen to hide phone number But You can Send Interest & Accept by Member After then You Can See Contact Number</label>
                    @endif
                </div>
            </div>
            <div class='form-group'>
