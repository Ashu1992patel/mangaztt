                        ...
                        <div class="col-md-9 col-sm-12 col-xs-12 width100 padd0">
                            ...
                            <div class="cand_box cand_profile_containner">
                                ...
                                <div class="cand_details u_info">
                                    ...
                                    <ul class="cand_info">
                                        ...
                                        <li data-toggle="tooltip" data-placement="bottom"
                                            title="{{$user->password}}">{{\Illuminate\Support\Str::limit( $user->password,28)}}</li>
                            ...
                            <div class="card view_card" id="view_about_blk">
                                <div class="card_basic_header">
                                    <h3>About {{ucwords($user->name)}}{{' (MM-'.$user->id.')'}}
                                        ...
                                        <div class="col-sm-6 ">
                                            <ul class="cand_info view_details_box">
                                                ...
                                                <li>@if(isset($user->education)) <a data-toggle="tooltip"
                                                                                    ...
                                                                                    title="{{$user->education}}">{{\Illuminate\Support\Str::limit($user->education,25)}}</a> @else {{'Not 
mentioned'}} @endif
                                                </li>
                                ...
                                <div class="card-body">
                                    <div class="col-sm-6">
                                        <ul class="cand_info view_details_box">
                                            ...
                                            <li class="font_bolt">Partner Education </li>
                                            <li>
                                                {{isset($user->education_partner)?$user->education_partner:'Not mentioned'}}
                                            </li>
                                            <li class="font_bolt">Partner Occupation  </li>
                                            <li>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul class="similor_profile_ul style-scroll">
                                            @foreach($similar_user as $similar)
                                                ...
                                                @endphp
                                                <li onclick="window.location = '{{url('view_profile_admin').'/'.$similar->id}}'">
