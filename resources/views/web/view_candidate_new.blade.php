                        ...
                        <div class="col-sm-12 col-md-3 width100">
                            <div class="right_side_viewblk">
                                <div class="card more_details">
                                    <div class="card-body">
                                        <h3 class="margin_top0">HOROSCOPE
                                            OF {{$user->gender == 'male'?'MALE':'FEMALE'}}</h3>
                                        <ul class="list-unstyled view_more_details_ul">
                                            <li>Place of Birth</li>
                                            @if($user->is_show_dob == '1' || $user->is_show_dob == '2')
                                                @if($user->is_show_dob == '2' && $result[0]->status_ == 'FRIENDS')
                                                    <li> {{isset($user->bop)?$user->bop:'Not mentioned'}}
                                                    </li>
                                                @elseif($user->is_show_dob == '1')
                                                    <li> {{isset($user->bop)?$user->bop:'Not mentioned'}}
                                                    </li>
                                                @else
                                                    <li>Protected</li>
