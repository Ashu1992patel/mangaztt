...
Route::POST('reset_password', [LoginMasterController::class, 'reset_password']);
...
Route::post('admin_login', [LoginMasterController::class, 'store']);
...
Route::POST('upload_pic', [User_loginController::class, 'upload_pic']);
...
Route::POST('aadhar_upload', [User_loginController::class, 'aadhar_upload']);
...
Route::post('privacy_update', [FrontendController::class, 'privacy_update']);
...
Route::POST('admin_s_user', [ProfileController::class, 'admin_s_user']);
