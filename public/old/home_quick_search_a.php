...
<title>Mangal Mandap | Quick Search</title>
                ...
                <td width="96%" align="right" valign="top" background="images/headerbox_C.jpg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
					...
					if(isset($_SESSION["me"])){
						echo "<div style='float: left; margin-top: 15px;'>Welcome, <a href='manage_a.php' title='Manage Account' style='color: white;'><u>".$_SESSION["me"]["name"]."</u></a>! (".$_SESSION["me"]["id"].") &nbsp;&nbsp;&nbsp;<a href='logout.php' title='Logout' style='color: white;'>Logout</a></div>";
					}?></td>
...
<table width="190" cellpadding="2" cellspacing="0">
  ...
  <tr>
   ...
   <tr>
    <td height="25" align="left" class="sachingray"><p><img src="images/arrows-2.jpg" width="8" height="8" />&nbsp;&nbsp;<a href="home_all_inactive_a.php"  class="blink2">All Inctive Profiles</a></p></td>
  </tr>
  <tr>
