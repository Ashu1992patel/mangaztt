	...
	if(isset($_SESSION["me"]))
	{
		...
		{	
			...
			{	extract($_POST);
				...
				$sql="SELECT * FROM profiles WHERE (gender!='".$_SESSION["me"]["gender"]."') and (".$status." 0) and (".$lang." 0) and (".$rel." 0) and (".$cast." 0) and (".$starr." 0) and (".$edu." 0) and (".$occu." 0) and (".$emp." 0) and (".$stt." 0) and (".$ctry." 0) and (".$ctzen." 0) and (".$children.") and (".$mang.") and (".$phy.") and (".$dyt.") ORDER BY ID DESC LIMIT 0, 500";
			...
			{	$flag="no";
				...
				{	
					...
					echo "<tr valign='bottom'><td></td><td class='details' align='right'><a class='gpd' href='?prflid=" . $row["id"]. "'>Get Details</a></td></tr>";
