...
<?php
		...
		{								
			...
			{	$dob=$year."-".$month."-".$day;
				if($status == "Never married")
					$add = "UPDATE profiles SET email='$email', name='$name', gender='$gender', dob='$dob', height='$height', physical='$physical', blood_group='$blood_group', body_type='$body_type', weight='$weight', complexion='$complexion', diet='$diet', gotra='$gotra', star='$star', rashi='$rashi', tob='$tob', status='$status', religion='$religion', caste='$caste', subcaste='$subcaste', manglik='$manglik', language='$language', education='$education', education_detail='$education_detail', occupation='$occupation', occupation_detail='$occupation_detail', salary='$salary', employed_in='$employed_in', state='$state', city='$city', address='$address', mob='$mob', country='$country', citizenship='$citizenship', f_values='$f_values', f_type='$f_type', f_status='$f_status', brothers='$brothers', sisters='$sisters', bro_married='$bro_married', sis_married='$sis_married', father_occupation='$father_occupation', mother_occupation='$mother_occupation', origin='$origin', p_agefrom='$p_agefrom', p_ageto='$p_ageto', p_status='$p_status', p_children='$p_children', p_heightfrom='$p_heightfrom', p_heightto='$p_heightto', p_physical='$p_physical', p_salary='$p_salary', p_religion='$p_religion', p_language='$p_language', p_city='$p_city', p_state='$p_state', about_me='$about_me' WHERE id=".$_SESSION["me"]["id"];
				else
					$add = "UPDATE profiles SET email='$email', name='$name', gender='$gender', dob='$dob', height='$height', physical='$physical', blood_group='$blood_group', body_type='$body_type', weight='$weight', complexion='$complexion', diet='$diet', gotra='$gotra', star='$star', rashi='$rashi', tob='$tob', status='$status', children='$children', living='$living', religion='$religion', caste='$caste', subcaste='$subcaste', manglik='$manglik', language='$language', education='$education', education_detail='$education_detail', occupation='$occupation', occupation_detail='$occupation_detail', salary='$salary', employed_in='$employed_in', state='$state', city='$city', address='$address', mob='$mob', country='$country', citizenship='$citizenship', f_values='$f_values', f_type='$f_type', f_status='$f_status', brothers='$brothers', sisters='$sisters', bro_married='$bro_married', sis_married='$sis_married', father_occupation='$father_occupation', mother_occupation='$mother_occupation', origin='$origin', p_agefrom='$p_agefrom', p_ageto='$p_ageto', p_status='$p_status', p_children='$p_children', p_heightfrom='$p_heightfrom', p_heightto='$p_heightto', p_physical='$p_physical', p_salary='$p_salary', p_religion='$p_religion', p_language='$p_language', about_me='$about_me' WHERE id=".$_SESSION["me"]["id"];
				if(mysqli_query($conn,$add) === TRUE)
				{	
					echo "<div class='confirm'>Your profile has been successfully updated!</div>";
	...
	else
	{
		...
		{								
			...
			{	$dob=$year."-".$month."-".$day;
				if($status == "Never married")
					$add = "UPDATE profiles SET email='$email', name='$name', gender='$gender', dob='$dob', height='$height', physical='$physical', blood_group='$blood_group', body_type='$body_type', weight='$weight', complexion='$complexion', diet='$diet', gotra='$gotra', star='$star', rashi='$rashi', tob='$tob', status='$status', religion='$religion', caste='$caste', subcaste='$subcaste', manglik='$manglik', language='$language', education='$education', education_detail='$education_detail', occupation='$occupation', occupation_detail='$occupation_detail', salary='$salary', employed_in='$employed_in', state='$state', city='$city', address='$address', mob='$mob', country='$country', citizenship='$citizenship', f_values='$f_values', f_type='$f_type', f_status='$f_status', brothers='$brothers', sisters='$sisters', bro_married='$bro_married', sis_married='$sis_married', father_occupation='$father_occupation', mother_occupation='$mother_occupation', origin='$origin', p_agefrom='$p_agefrom', p_ageto='$p_ageto', p_status='$p_status', p_children='$p_children', p_heightfrom='$p_heightfrom', p_heightto='$p_heightto', p_physical='$p_physical', p_salary='$p_salary', p_religion='$p_religion', p_language='$p_language', about_me='$about_me', about_fam='$about_fam' WHERE id=".$_SESSION["me"]["id"];
				else
					$add = "UPDATE profiles SET email='$email', name='$name', gender='$gender', dob='$dob', height='$height', physical='$physical', blood_group='$blood_group', body_type='$body_type', weight='$weight', complexion='$complexion', diet='$diet', gotra='$gotra', star='$star', rashi='$rashi', tob='$tob', status='$status', children='$children', living='$living', religion='$religion', caste='$caste', subcaste='$subcaste', manglik='$manglik', language='$language', education='$education', education_detail='$education_detail', occupation='$occupation', occupation_detail='$occupation_detail', salary='$salary', employed_in='$employed_in', state='$state', city='$city', address='$address', mob='$mob', country='$country', citizenship='$citizenship', f_values='$f_values', f_type='$f_type', f_status='$f_status', brothers='$brothers', sisters='$sisters', bro_married='$bro_married', sis_married='$sis_married', father_occupation='$father_occupation', mother_occupation='$mother_occupation', origin='$origin', p_agefrom='$p_agefrom', p_ageto='$p_ageto', p_status='$p_status', p_children='$p_children', p_heightfrom='$p_heightfrom', p_heightto='$p_heightto', p_physical='$p_physical', p_salary='$p_salary', p_religion='$p_religion', p_language='$p_language', about_me='$about_me' ,about_fam='$about_fam' WHERE id=".$_SESSION["me"]["id"];
				if(mysqli_query($conn,$add) === TRUE)
				{	
