		...
		{	extract($_POST);
			if(isset($view)){
				...
				echo "<tr valign='top'><td class='details'><strong>Email ID: </strong>".$detail["email"]."</td></tr>";
					...
					echo "<tr> <td><center> <a href='payment.php'><div style='color: red;'> <u>Confirm payment to get contact details of this person...</u></div></a> </center></td></tr>";
			...
			if(($religion=="Any") && ($language!="Any")){
				$sql="SELECT * FROM profiles WHERE gender!='".$_SESSION["me"]["gender"]."' and language='$language' ORDER BY id DESC ";
			}
			elseif(($religion!="Any") &&  ($language=="Any")){
				$sql="SELECT * FROM profiles WHERE gender<>'".$_SESSION["me"]["gender"]."' and religion='$religion' ORDER BY id DESC ";
			}
			elseif(($religion=="Any") && ($language=="Any")){
				$sql="SELECT * FROM profiles WHERE gender<>'".$_SESSION["me"]["gender"]."' ORDER BY id DESC ";
			}
			else{
				$sql="SELECT * FROM profiles WHERE gender<>'".$_SESSION["me"]["gender"]."' and religion='$religion' and language='$language' ORDER BY id DESC";
			}
			...
			{	$flag="no";
				...
				{	
					...
					echo "<tr valign='bottom'><td></td><td class='details' align='right'><input type='submit' name='view' value='Get Details'></td></tr>";
