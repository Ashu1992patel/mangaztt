...
if($plan=="Diamond"){
			...
			{	
			if(($religion=="Any") && ($language!="Any")){
				$sql="SELECT * FROM profiles WHERE gender='$gender' and language='$language' ORDER BY id DESC ";
			}
			elseif(($religion!="Any") &&  ($language=="Any")){
				$sql="SELECT * FROM profiles WHERE gender='$gender' and religion='$religion' ORDER BY id DESC ";
			}
			elseif(($religion=="Any") && ($language=="Any")){
				$sql="SELECT * FROM profiles WHERE gender='$gender' ORDER BY id DESC";
			}
			else{
				$sql="SELECT * FROM profiles WHERE gender='$gender' and religion='$religion' and language='$language' ORDER BY id DESC";
			}
			...
			{	$flag="no";
				...
				if(($age->format("%y") < $ageto) && ($age->format("%y") > $agefrom))
					$flag="yes";
				echo "<tr valign='top'>";
				...
				{	
					...
					if($check["active"]=="no"){
						...
						echo "<td class='details' align='left'><font color='orange'>Active now</font>&nbsp;&nbsp;<input type='submit' name='deactivate' value='Deasctivate'></td>";
					echo "</form>";
