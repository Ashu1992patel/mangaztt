...
<?php
$link = mysql_connect("localhost","mangaztt_user","Ajit@@123","mangaztt_marriagedb");
mysql_select_db("mangaztt_marriagedb", $link);

$result = mysql_query("SELECT * FROM activate", $link);
$Totaluser= mysql_num_rows($result);

$result1 = mysql_query("SELECT * FROM activate where active='yes'", $link);
...
<title>Admin Home | Mangal Mandap</title>
              ...
              <tr>
                ...
                <td width="96%" align="right" valign="top" background="images/headerbox_C.jpg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
					...
					if(isset($_SESSION["admin"])){
						echo "<div style='float: left; margin-top: 15px;'>Welcome, <a href='manage_a.php' title='Manage Account' style='color: white;'><u>".$_SESSION["admin"]["uid"]."</u></a>! &nbsp;&nbsp;&nbsp;<a href='logout.php' title='Logout' style='color: white;'>Logout</a><br> Total Users:".$Totaluser."<br>Total Active Users:".$Activeuser."
...
<table width="190" cellpadding="2" cellspacing="0">
  ...
  <tr>
    <td height="25" bgcolor="#9A005A"><p class="style17">Admin Home </p></td>
  </tr>
  ...
  <tr>
    <td height="66" align="left" valign="top" class="sachingray"><form ondragstart="return false" onselectstart="return false" oncontextmenu="return false" action="" method="post" name="search_by_id" id="formbyid" style="margin-left:0; margin-right:0; margin-bottom:0; margin-top:">
      <p align="left"><img src="images/arrows-2.jpg" width="8" height="8" />&nbsp;<span class="style2">&nbsp;<span class="style4">
      </span></span><br />
        &nbsp; &nbsp;
        <input tabindex="40" size="12" name="id" onkeydown="javascript: return chk4id();" onkeypress="javascript:return chk4schar();" />
        <input name="search" type="submit" id="submit1" accesskey="13" value="Goo" onclick="return CheckBlank()"/>
        </p>
    </form></td>
  </tr>
  <tr>
...
<td width="80%" align="left" valign="top"><table width="95%" border="0" align="left" cellpadding="0" cellspacing="3">
...
?>
  ...
  <tr>
    <td align="center" valign="top" background="images/down_bg.jpg" bgcolor="#A20055" class="style26" style="background-repeat:repeat-x"><table  align="center" width="1002" border="0" cellpadding="0" cellspacing="0">
