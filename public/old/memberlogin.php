...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top" background="images/top_bg.jpg" bgcolor="#EAE4E6" style="background-repeat:repeat-x;"><table width="1000" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="mainborder">
      <tr>
        <td height="50" align="center" valign="middle" bgcolor="#87004F" class="phead"> </td>
      </tr>
      <tr>
        <td background="images/header_bg.jpg" style="background-repeat:repeat-x;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td align="left" valign="top" bgcolor="#FFFFFF"><table width="98%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td><img src="images/title_login.jpg" width="262" height="43" /></td>
              </tr>
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td width="62%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td width="100%" align="left" valign="top"><p class="onebig1"> Existing Member Login here </p></td>
                      </tr>
                      <tr>
                        <td align="center" valign="middle">
						<form action="index.php" id="loginForm" name="loginForm" method="post"  onsubmit="return validateFields()">
            ...
            border="0">
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td colspan="2" align="left"><p><font face="Arial, Helvetica, sans-serif" size="1">
                                    <input name="email" id="email" placeholder="Email / Profile ID" tabindex="1" size="16" onkeydown="javascript: return chk4id();" onkeypress="javascript:return chk4schar();"/>
                                </font></p></td>
                              </tr>
                              <tr>
                                <td align="right">&nbsp;</td>
                  ...
                  size="1">
                                    <input name="password" type="password" id="password" placeholder="******" tabindex="2" onkeydown="javascript: return chk4pass();" size="16" maxlength="14" />
                                </font></p></td>
                              </tr>
                              <tr>
                                <td align="right" >&nbsp;</td>
                  ...
                  src="images/go1.gif" name="submit"  value="Login" width="14" height="14" border="0" style="border:none"/>
                                </p></td>
                              ...
                              <tr>
                                <td colspan="3" align="left" ><p><font face="Verdana"><span class="style7">If you are a new 
                                  user Click here for</span> <a href="registration.php" class="pagelink">FREE 
                                        Registration</a></font></p></td>
                              </tr>
                            </tbody>
                          </table>
                        </form></td>
