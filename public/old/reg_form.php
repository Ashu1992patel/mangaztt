<tr><td><form action="" method="post" name="form1" id="form1" onsubmit="javascript:return validateFields()">
                      <table width="98%" border="0" align="center" cellpadding="1" cellspacing="1">
                        ...
                        <tr valign="top">
                          <td height="21" colspan="2"><p class="style12">Welcome to MangalMandap.com Create your matrimonial   profile to find your match. <span class="txthead">Please complete the form below to register your profile</span><span class="style13">. </span></p></td>
                        </tr>
                        <tr valign="top">
                          <td width="203">&nbsp;</td>
                          <td width="710" align="right"><p><span class="style14">All fields are mandatory </span></p></td>
                        </tr>
                        <tr valign="top">
                        ...
                        <tr valign="top">
                          ...
                          <td height="30"><p><strong>
                              <input name="email" type="text" id="email" tabindex="0" onkeypress="javascript:return chk4schar();" onkeydown="javascript: return chk4id();" size="28" maxlength="60" />
                              <br />
                              </strong></p></td>
                        </tr>
                        <tr valign="top">
                          <td height="24" align="right"><p><strong>Choose Password</strong></p></td>
                          <td height="24"><p><strong>
                              <input name="password" type="password" id="password" onkeydown="javascript: return chk4pass();" size="28" maxlength="25" />
                          </strong></p></td>
                        </tr>
                        <tr valign="top">
                          <td height="24" align="right"><p><strong>Confirm Password</strong></p></td>
                          <td height="24"><p><strong>
                              <input name="password1" type="password" id="password1" onkeydown="javascript: return chk4pass();" size="28" maxlength="25" />
                          </strong><span class="style14">Set Password more then 5    Characters </span></p></td>
                        </tr>
                        ...
                        <tr valign="top">
                          <td height="24" align="right"><p><span class="style18">Name</span></p></td>
                          <td height="24"><p><strong>
                              <input name="name" type="text" id="name" size="28" maxlength="30" value="" onkeypress="javascript: return chkspecialchars();" />
                          </strong></p></td>
                        </tr>
                        <tr valign="top">
                          <td height="24" align="right"><p class="style12">Gender</p></td>
                          <td height="24"><p>
                              <input name="gender" type="radio" class="t1" value="male" checked="checked" />
                            Male&nbsp;&nbsp;&nbsp;&nbsp;
                            <input name="gender" type="radio" class="t1" value="female" />
                            Female </p></td>
                        </tr>
                        <tr>
                          <td height="30" align="right" valign="top"><p class="style12">D.O.B.</p></td>
            ...
            color="#000000" size="1" face="Verdana," arial,="Arial," sans-serif,="sans-serif," tahoma="Tahoma">
                        ...
                        <tr valign="top">
                          ...
                          <td height="26"><table width="100%" cellpadding="0" cellspacing="0">
                              <tr>
                                <td height="20"><p>
                                  <input name="status" type="radio" class="t1" onClick="javascript:return ChkMarriedOption();" value="Never married" checked="checked" />Never Married&nbsp;&nbsp;
                                    <input name="status" type="radio" class="t1" value="Divorced" onClick="javascript:return childrenenable();" />Divorced&nbsp;&nbsp;
                                    <input name="status" type="radio" class="t1" value="Widowed" onClick="javascript:return childrenenable();" />Widowed
                                    &nbsp;
                                    <input name="status" type="radio" class="t1" value="Separated" onClick="javascript:return childrenenable();" />Separated
                                  </p></td>
                              </tr>
                          </table></td>
                        </tr>
                        <tr>
                          <td height="26" align="right"><p class="style12">No. of Children</p></td>
                          <td height="26" align="left"><p><strong><font color="#008080"size="2">
                              <select name="children" id="children" onChange="javascript:return setLiving();" disabled="disabled">
                                ...
                                <option value="5">5</option>
                                  ...
                                  &nbsp;&nbsp;&nbsp;Children living: 
                                  <input type="radio" name="living" value="Living with me" class="t1" disabled="disabled" />
                                  Living  with me<span class="style18">&nbsp;&nbsp;
                                  <input type="radio" name="living" value="Not living with me" class="t1" disabled="disabled" />
                                  </span>Not living  with me<span class="style18">&nbsp;&nbsp;</span></p></td>
                        </tr>
                        <tr valign="top">
                          <td height="24" align="right"><p><span class="style18">Religion</span></p></td>
                          <td height="24"><p>
                        ...
                        <tr valign="top">
                          ...
                          <td height="24"><p><font color="#000000" size="1" face="Verdana," arial,="Arial," sans-serif,="sans-serif," tahoma="Tahoma">
                            <input name="manglik" type="radio" value="no" checked="checked" />
                              ...
                              Yes
							<input name="manglik" type="radio" value="dnot know" />
                              Don't know </span></font></p></td>
                        </tr>
                        <tr valign="top">
                          <td height="24" align="right"><p><span class="style18">Mother Tongue</span></p></td>
                          <td height="24"><p>
                        ...
                        <tr valign="top">
                          ...
                          <td height="24"><p><font color="#008080" size="2">
                            <input name="education_detail" class="forminput" onkeypress="javascript: return chkspecialchars();" size="30" maxlength="100" />
                        ...
                        <tr valign="top">
                          <td align="right"><p><strong>Occupation 
                            detail</strong></p></td>
                          <td height="24"><p>
                            <input name="occupation_detail" class="forminput" onkeypress="javascript: return chkspecialchars();" size="30" maxlength="100"/>                             
                            (Optional)</p></td>
                        </tr>
                        <tr valign="top">
                        ...
                        <tr valign="top">
                          <td height="24" align="right"><p class="style12">Employed in</p></td>
                          <td height="24"><p>
                            <input type="radio" name="employed_in" value="Govt" class="t1" checked/>
                            Government
                            <input type="radio" name="employed_in" value="Private" class="t1" />
                            Private
                            <input type="radio" name="employed_in" value="Business" class="t1" />
                            Business
                            <input type="radio" name="employed_in" value="Defence" class="t1" />
                            Defence
                            <input type="radio" name="employed_in" value="Not working" class="t1" />
                            Not  working</p></td>
                        </tr>
                        <tr>
                          <td align="right">&nbsp;</td>
                        ...
                        <tr>
                          ...
                          <td align="left"><p>
                              <input name="city" class="forminput" onkeypress="javascript: return chkspecialchars();" size="30" maxlength="45" />
                          </p></td>
                        </tr>
                        <tr>
                          <td height="77" align="right" valign="top"><p class="style21"><strong>Contact Address</strong></p></td>
                          <td align="left"><p>
                              <textarea name="address" cols="30" rows="4" class="forminput" onkeypress="javascript: return chkspecialchars();"></textarea>
                              </p></td>
                        </tr>
                        <tr>
                          ...
                          <td align="left"><p><span class="style14"><img width="1" height="1" src="RegistrationOne_clip_image001_0001.php" /> &nbsp;&nbsp;Mobile Number </span><br />
                            ...
                            <input name="mob" placeholder="contact no. 1"type="text" id="mob" size="11" maxlength="12" onkeypress="Javascript: return chknum()" required/>
							<input name="mob2" placeholder="contact no. 2"type="text" id="mob2" size="11" maxlength="12" onkeypress="Javascript: return chknum()" />
                            </p></td>
                        </tr>
                        ...
                        <tr valign="top">
                          <td>&nbsp;</td>
                          <td><p>
                            <input type="checkbox" name="chkTerms" value="True" />
                            <font face="Verdana," arial,="arial," sans-serif,="sans-serif," tahoma="tahoma" color="#FF0000" 
            size="1"> </font><font color="#666666" 
            size="1" face="Verdana," class="style10" arial,="arial," sans-serif,="sans-serif," tahoma="tahoma">Please tick this box to indicate that you have read and agree 
                              to the <a href="T%26C.php" target="_blank" class="style10">Terms 
                                &amp; Conditions</a> of Service</font></p></td>
                        </tr>
                        <tr valign="top">
                          <td>&nbsp;</td>
                          <td>&nbsp;</td>
                        ...
                        <tr valign="top">
                          ...
                          <td><input type="submit" name="submit" value="Create My Profile" onclick="javascript: return htplace()" />                          </td>
                        </tr>
                        <tr valign="top">
                          <td>&nbsp;</td>
                          <td>&nbsp;</td>
